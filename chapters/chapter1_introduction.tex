...
%==========================================================
% FEATURE SELECTION CHART IMAGE
%==========================================================
\vspace{1.5cm}
\begin{center}
    \includegraphics[width=0.88\textwidth]{FSchart.jpeg}
    \captionof{figure}{Feature Selection Methods Overview}\citep{a_review_of_feature}
\end{center}
%=========================================================
